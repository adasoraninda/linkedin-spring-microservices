package com.adasoraninda.explorcali;

import com.adasoraninda.explorcali.service.TourPackageService;
import com.adasoraninda.explorcali.service.TourService;
...
public class ExplorcaliApplication implements CommandLineRunner {
    @Value("${ec.importfile}")
    ...
    public static void main(String[] args) {
        SpringApplication.run(ExplorcaliApplication.class, args);
    }
